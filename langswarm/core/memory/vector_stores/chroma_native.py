...
class NativeChromaStore(IVectorStore):
    ...
    async def disconnect(self) -> bool:
        ...
        try:
            ...
            handle_error(e, "chroma_disconnect")
            return False
    ...
    async def create_index(self, name: str, dimension: int, metric: str = "cosine") -> bool:
        ...
        try:
            ...
            handle_error(e, "chroma_create_index")
            return False
    ...
    async def delete_index(self, name: str) -> bool:
        ...
        try:
            ...
            handle_error(e, "chroma_delete_index")
            return False
    ...
    async def get_document(self, doc_id: str) -> Optional[VectorDocument]:
        ...
        try:
            ...
            handle_error(e, "chroma_get_document")
            return None
    ...
    async def delete_documents(self, doc_ids: List[str]) -> bool:
        ...
        try:
            ...
            handle_error(e, "chroma_delete_documents")
            return False
    ...
    async def list_documents(self, limit: int = 100, filters: Optional[Dict[str, Any]] = None) -> List[str]:
        ...
        try:
            ...
            handle_error(e, "chroma_list_documents")
            return []
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            handle_error(e, "chroma_get_stats")
            return {"error": str(e)}
    ...
    async def health_check(self) -> bool:
        ...
        try:
            ...
            handle_error(e, "chroma_health_check")
            return False
    ...
    async def _ensure_collection(self) -> bool:
        ...
        try:
            ...
            handle_error(e, "chroma_ensure_collection")
            return False
