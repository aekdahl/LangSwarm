...
class NativeSQLiteStore(IVectorStore):
    ...
    async def disconnect(self) -> bool:
        ...
        try:
            ...
            handle_error(e, "sqlite_disconnect")
            return False
    ...
    async def create_index(self, name: str, dimension: int, metric: str = "cosine") -> bool:
        ...
        try:
            ...
            handle_error(e, "sqlite_create_index")
            return False
    ...
    async def delete_index(self, name: str) -> bool:
        ...
        try:
            ...
            handle_error(e, "sqlite_delete_index")
            return False
    ...
    async def get_document(self, doc_id: str) -> Optional[VectorDocument]:
        ...
        try:
            ...
            handle_error(e, "sqlite_get_document")
            return None
    ...
    async def delete_documents(self, doc_ids: List[str]) -> bool:
        ...
        try:
            ...
            handle_error(e, "sqlite_delete_documents")
            return False
    ...
    async def list_documents(self, limit: int = 100, filters: Optional[Dict[str, Any]] = None) -> List[str]:
        ...
        try:
            ...
            handle_error(e, "sqlite_list_documents")
            return []
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            handle_error(e, "sqlite_get_stats")
            return {"error": str(e)}
    ...
    async def health_check(self) -> bool:
        ...
        try:
            ...
            handle_error(e, "sqlite_health_check")
            return False
