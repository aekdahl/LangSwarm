# LangSwarm Tool System Documentation

**Complete documentation for the unified LangSwarm tool system**

## 🎯 Overview

LangSwarm features a unified tool system that consolidates different tool types into a single, consistent MCP-based architecture. This documentation provides everything you need to understand, use, and develop tools in the system.
...
- **[🚀 Unified System Overview](architecture)** - Understand the V2 tool architecture
- **[📖 User Guides](./)** - Learn how to use tools effectively

### **Using Tools**
- **[🔧 MCP Local Mode](mcp/local-mode)** - Zero-latency tool execution
- **[🌐 MCP Remote Mode](mcp/remote-mode)** - Distributed tool execution
- **[💭 Intent-Based Calls](intent-based-calls)** - Natural language tool usage
- **[🔗 Tool Chaining](tool-chaining)** - Connecting tools together

### **Developing Tools**
- **[🛠️ Tool Development](../../developer-guides/mcp-tool-development)** - Build custom tools
- **[📋 MCP Developer Guide](../../developer-guides/mcp-tool-development)** - Complete MCP tool guide
- **[🔄 Migration Guide](migration)** - Migrate from V1 tool types

### **MCP Ecosystem**
- **[🌍 MCP Overview](mcp/local-mode)** - Complete MCP ecosystem documentation
- **[🔧 MCP Development](../../developer-guides/mcp-tool-development)** - Building MCP tools

---

## 📊 **Unified Tool System Benefits**
...
Complete overview of the unified tool architecture.

- **Architecture Overview**: Tool system design
- **Performance Improvements**: Async execution and optimization

### **[🔧 MCP Ecosystem](mcp/local-mode)**
Comprehensive MCP (Model Control Protocol) documentation.

- **[Overview](mcp/local-mode)**: MCP ecosystem and standards
- **[Development](../../developer-guides/mcp-tool-development)**: Building MCP tools  
- **[Migration](migration)**: Converting tools to MCP

### **[🎯 User Guides](./)**
How to use tools effectively in your LangSwarm applications.

- **[MCP Local Mode](mcp/local-mode)**: Zero-latency local execution
- **[MCP Remote Mode](mcp/remote-mode)**: Distributed tool execution
- **[Intent-Based Tool Calls](intent-based-calls)**: Natural language usage
- **[Tool Chaining](tool-chaining)**: Connecting tools together

### **[🛠️ Developer Guides](../../developer-guides/mcp-tool-development)**
Building and extending the tool system.

- **[MCP Developer Guide](../../developer-guides/mcp-tool-development)**: Complete development guide
- **[Tool Development Patterns](../../developer-guides/mcp-tool-development)**: Best practices and patterns
- **[Testing Strategies](../../developer-guides/mcp-tool-development)**: Testing tools effectively
...
**The LangSwarm tool system provides a powerful, unified platform for extending LangSwarm functionality while maintaining simplicity and consistency across all tool types.**
